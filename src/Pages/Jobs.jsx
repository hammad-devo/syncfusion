        ...
        <Grid container justifyContent={'center'}>
            <Grid xs={12} xl={10} lg={10} >
                    <Paper elevation={3} sx={{width:"100%",padding:'7% 2%'}} >
                        ...
                        <Typography variant='h6' fontWeight={'bold'} fontFamily={'cursive'} width={'100%'} textAlign={'center'}>
                            PhotoShop Editing
                        </Typography>
                    ...
                    <Box marginTop={'30px'} width={'100%'}>
                        ...
                        <Grid  container justifyContent={'flex-start'} columnGap={2}>
                            <Grid marginTop={'20px'} lg={3.9} xl={3.9} xs={5.8} sm={5} md={5}>
                                <Paper onClick={()=>navigate('/details')} className='transformParent' sx={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'20px 14px',cursor:'pointer'}} elevation={3}>
                                    <Box>
                    ...
                    <Box marginTop={'30px'} width={'100%'}>
                       ...
                       <Box display={'flex'} flexWrap={'nowrap'} sx={{overflowX:'scroll',paddingBottom:'10px'}} className='scroll'>
                            <Paper onClick={()=>navigate('/details')}  className='transformParent' sx={{display:'flex',justifyContent:'space-between',alignItems:'center',padding:'20px 14px',cursor:'pointer',minWidth:'300px',marginLeft:'10px'}} elevation={3}>
                                    <Box>
                                        <Typography variant='h6' fontWeight={'bold'} color={'darkblue'}>UI/UX designer</Typography>
                                        <Typography color={'#666666'}>Build ui/ux for us and earn</Typography>
                                    </Box>
